...
# def get_chunk(file_path, start=0, end=None):
#     """Reads and streams a video file in chunks."""
#     file_size = os.path.getsize(file_path)
#     end = min(end if end else file_size, file_size - 1)
...
#     # Process range request for partial content
...
#     chunk, start, end, file_size = get_chunk(file_path, start, end)
    
#     response = Response(chunk, status=206, mimetype="video/mp4", direct_passthrough=True)
